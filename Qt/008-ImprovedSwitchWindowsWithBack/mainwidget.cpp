...
MainWidget::MainWidget(StackedWidget* stackedWidget, QWidget *parent) : BaseWidget(parent)
{
...
void MainWidget::createFirstWidget()
{
    ...
    this->stackedWidget->getQStackedWidget()->addWidget(firstWidget);
    this->stackedWidget->getQStackedWidget()->setCurrentWidget(firstWidget);
}
